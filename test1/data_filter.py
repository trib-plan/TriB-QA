...
f = open("F:\TriB-QA\\test1\pred.json", "r", encoding='utf-8')
...
#             tmp["question"] = json_dicts["question"]
...
for each in readlines:
    ...
    if json_dicts["question_type"] == "YES_NO":
        ...
        for each_answer in json_dicts["answers"]:
            ...
            # elif json_dicts["yesno_answers"][pos] == "No":
            #     tmp["yesno_answers"] = 0
            # elif json_dicts["yesno_answers"][pos] == "Depends":
            tmp["yesno_answers"] = 2
            # print(json_dicts)
            # exit()
            # tmp["segmented_answers"]=json_dicts["segmented_answers"][pos]
...
fout = open("F:\TriB-QA\\test1\dev.json", 'w', encoding='utf-8')
fout.write(str0)
fout.close()
