...
writer = open("F:\\TriB-QA\data\\All.train.json",'w',encoding='utf-8')
...
with open("D:\迅雷下载\\train_preprocessed\\train_preprocessed\\trainset\\zhidao.train.json",encoding = 'utf-8') as reader:
    for line in reader:
        selected_segmented_para = []
        selected_para = []
        example = json.loads(line)
